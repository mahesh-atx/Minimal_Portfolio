    ...
    >
      ...
      <motion.div style={{ x: introX, y: introY }} className="w-full">
        <motion.div variants={fadeSlideUp} className="flex flex-col gap-[6px] w-full">
          ...
          />
          <p className="text-[15px] max-[809px]:text-[14px] font-medium leading-[1.4] text-black/60">
            ...
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="inline-block whitespace-nowrap text-[15px] max-[809px]:text-[14px] font-medium leading-[1.4] text-[#A3B565]"
              >
                {ROTATING[wordIdx]}
              </motion.span>
            </AnimatePresence>
